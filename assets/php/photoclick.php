...
$ma_posttimtho  = $_SESSION['ma_posttimtho'];
$mathongtinthue  = $_SESSION['mathongtinthue '];
$tenposttimtho = $_SESSION['tenposttimtho'];
$diadiem = $_SESSION['diadiem'];
$thoigian = $_SESSION['thoigian'];
$gia = $_SESSION['gia'];
$sukien = $_SESSION['sukien'];
$phongcach = $_SESSION['phongcach'];
$anhmau = $_SESSION['anhmau'];
$motachitiet = $_SESSION['motachitiet'];
